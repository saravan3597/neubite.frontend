/**
 * Centralized icon library — all icons are 24×24 stroke-based SVGs.
 * Every icon accepts an optional `className` (defaults to "w-5 h-5").
 * All use `stroke="currentColor"` so they automatically follow text colour
...
interface IconProps {
  className?: string;
  active?: boolean; // for fill-toggle icons (Dashboard, Heart)
}

// ── Navigation ──────────────────────────────────────────────────────────────

export const DashboardIcon = ({ className = 'w-5 h-5', active }: IconProps) => (
...
// Shelves — used everywhere pantry is referenced
export const PantryIcon = ({ className = 'w-5 h-5' }: IconProps) => (
...
// Clipboard with check — used everywhere grocery/shopping list is referenced
export const GroceryIcon = ({ className = 'w-5 h-5' }: IconProps) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
...
export const HeartIcon = ({ className = 'w-5 h-5', active }: IconProps) => (
  <svg className={className} fill={active ? 'currentColor' : 'none'} stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
...
export const BookmarkIcon = ({ className = 'w-5 h-5', active }: IconProps) => (
  <svg className={className} fill={active ? 'currentColor' : 'none'} stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
