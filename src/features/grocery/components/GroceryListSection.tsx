              ...
              {unpurchased.length === 0 ? (
                ...
                <ul className="space-y-1.5">
                  {unpurchased.map((item) => (
                    <li
                      key={item.id}
                      className="group flex items-center gap-3 px-3.5 py-2.5 rounded-xl border border-bg-secondary hover:border-accent-primary/30 hover:bg-bg-secondary/60 transition-all"
                    >
                      {/* Custom checkbox */}
                      <button
                        id={`grocery-check-${item.id}`}
                        onClick={() => handleCheckboxClick(item.id)}
                        className="shrink-0 w-5 h-5 rounded-md border-2 border-bg-secondary group-hover:border-accent-primary/50 flex items-center justify-center transition-colors hover:bg-accent-primary/10"
                      ...
                      <button
                        ...
                        className="opacity-0 group-hover:opacity-100 p-1 rounded-lg text-text-secondary hover:text-status-error hover:bg-status-error/10 transition-all"
                        title="Remove item"
                      >
